...
def get_global_info():
  ...
  rfile = open(r"D:\ProgramData\Anaconda3\Scripts\deepcas\data\test-net\global_graph.txt",'r')
  for line in rfile:
    line = line.rstrip('\r\n')
    parts = line.split("\t\t")
    source = int(parts[0])
...
def read_graphs(which_set):
  graph_cnt = 0
  graph_file = r"D:\ProgramData\Anaconda3\Scripts\deepcas\data\test-net\cascade_" + which_set + ".txt"
  graph_walk_file = r"D:\ProgramData\Anaconda3\Scripts\deepcas\data\test-net\random_" + which_set + ".txt"
...
def learn_embeddings(walks, embeding_size):
  print('ok')
  embed_file = r"D:\ProgramData\Anaconda3\Scripts\deepcas\data\test-net\node_vec_" + str(embeding_size) + ".txt"
